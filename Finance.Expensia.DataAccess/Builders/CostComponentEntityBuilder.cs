    ...
    public class CostComponentEntityBuilder : EntityBaseBuilder<CostComponent>
    {
        ...
        private static void SeedingData(EntityTypeBuilder<CostComponent> builder)
        {
            builder.HasData(
                ...
                new CostComponent { Id = new Guid("56baf335-7326-455d-a9bb-517eafcbc4d3"), CostComponentNo = 29000, CostComponentName = "Total Potongan", CostComponentType = CostComponentType.SubTotal, CostComponentCategory = CostComponentCategory.MonthlyDeductionBenefit, Remark = "", IsCalculated = true, CalculateFormula = "[20000] + [20100] + [21000] + [21100] + [21200] + [22000]", IsActive = true, IsVisible = true, CreatedBy = "", Created = new DateTime(2024, 11, 8, 12, 56, 0, DateTimeKind.Utc), RowStatus = 0 },

                new CostComponent { Id = new Guid("90c8198b-8038-4cda-940e-7033c00bcbac"), CostComponentNo = 29999, CostComponentName = "Take Home Pay", CostComponentType = CostComponentType.Total, CostComponentCategory = CostComponentCategory.Total, Remark = "Estimation", IsCalculated = true, CalculateFormula = "[19000] - [29000]", IsActive = true, IsVisible = true, CreatedBy = "", Created = new DateTime(2024, 11, 8, 12, 56, 0, DateTimeKind.Utc), RowStatus = 0 },
                ...
                new CostComponent { Id = new Guid("21ffa1c8-da11-449b-9115-bb0733dbfa97"), CostComponentNo = 44000, CostComponentName = "Laptop", CostComponentType = CostComponentType.Monthly, CostComponentCategory = CostComponentCategory.OtherBenefit, Remark = "Non Taxable", IsCalculated = true, CalculateFormula = "if([LaptopOwnership] == 1, 300000, 0)", IsActive = true, IsVisible = false, CreatedBy = "", Created = new DateTime(2024, 11, 8, 12, 56, 0, DateTimeKind.Utc), RowStatus = 0 },

                new CostComponent { Id = new Guid("adf2853f-3b7e-4f8e-9885-9e7a451600cf"), CostComponentNo = 50000, CostComponentName = "Pembayaran BPJS Kesehatan 5%", CostComponentType = CostComponentType.Monthly, CostComponentCategory = CostComponentCategory.GovernmentDeduction, Remark = "Deduction", IsCalculated = true, CalculateFormula = "if([10000] < 12000000, [10000] * 0.05, 12000000 * 0.05)", IsActive = true, IsVisible = false, CreatedBy = "", Created = new DateTime(2024, 11, 8, 12, 56, 0, DateTimeKind.Utc), RowStatus = 0 },
                ...
                new CostComponent { Id = new Guid("1295d083-8086-447b-9cc0-6caa1c5266ff"), CostComponentNo = 91000, CostComponentName = "Annual COGS", CostComponentType = CostComponentType.Total, CostComponentCategory = CostComponentCategory.Total, Remark = "", IsCalculated = true, CalculateFormula = "([29999] + [42000] + [43000] + [44000] + [59000]) * 12 + [31000] + [32000] + [40000] + [41000]", IsActive = true, IsVisible = false, CreatedBy = "", Created = new DateTime(2024, 11, 8, 12, 56, 0, DateTimeKind.Utc), RowStatus = 0 },
                new CostComponent { Id = new Guid("9dc90145-46a7-47a1-9610-f8fa5ca9b5ea"), CostComponentNo = 92000, CostComponentName = "Monthly COGS", CostComponentType = CostComponentType.Total, CostComponentCategory = CostComponentCategory.Total, Remark = "", IsCalculated = true, CalculateFormula = "Ceiling([91000] / 12 / 100000) * 100000", IsActive = true, IsVisible = true, CreatedBy = "", Created = new DateTime(2024, 11, 8, 12, 56, 0, DateTimeKind.Utc), RowStatus = 0 }
            );
        }
    }
}
