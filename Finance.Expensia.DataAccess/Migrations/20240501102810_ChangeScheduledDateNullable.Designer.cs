...
namespace Finance.Expensia.DataAccess.Migrations
{
    ...
    [Migration("20240501102810_ChangeScheduledDateNullable")]
    partial class ChangeScheduledDateNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Finance.Expensia.DataAccess.Models.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("5df9b7c1-3bab-4390-afd8-603c53a06607"),
                            Created = new DateTime(2024, 2, 25, 15, 15, 29, 23, DateTimeKind.Utc).AddTicks(3910),
                            CreatedBy = "",
                        ...
                        new
                        {
                            Id = new Guid("64518cb1-3dd4-49bb-8077-b0c2b64a6481"),
                            Created = new DateTime(2024, 2, 25, 15, 15, 29, 23, DateTimeKind.Utc).AddTicks(3910),
                            CreatedBy = "",
                        ...
                        new
                        {
                            Id = new Guid("d5152d60-c9d7-4502-a71e-e0ccc9351df1"),
                            Created = new DateTime(2024, 2, 25, 15, 15, 29, 23, DateTimeKind.Utc).AddTicks(3910),
                            CreatedBy = "",
                            PermissionId = new Guid("f601f0dc-ec56-4088-a637-95eea2372daa"),
                            RoleId = new Guid("87312c58-9961-4578-bd05-8e0f96aaeb7f"),
                        ...
                        new
                        {
                            Id = new Guid("ffbf7b43-7175-4d25-abb5-98fb5a7bce00"),
                            Created = new DateTime(2024, 2, 25, 15, 15, 29, 23, DateTimeKind.Utc).AddTicks(3910),
                            CreatedBy = "",
                            PermissionId = new Guid("f0300010-c0df-4366-a9c3-994f3a3ad47f"),
                            RoleId = new Guid("87312c58-9961-4578-bd05-8e0f96aaeb7f"),
            ...
            modelBuilder.Entity("Finance.Expensia.DataAccess.Models.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            RowStatus = 0,
                            TransactionTypeCode = "REM"
                        },
                        new
                        {
                            Id = new Guid("3daf8acf-70d6-40b7-bf5f-2fb2f6ba9b31"),
                            Created = new DateTime(2024, 2, 25, 15, 15, 29, 22, DateTimeKind.Utc).AddTicks(7600),
                            CreatedBy = "",
                            Description = "Cash Advance",
                            RowStatus = 0,
                            TransactionTypeCode = "CAD"
                        });
                });
